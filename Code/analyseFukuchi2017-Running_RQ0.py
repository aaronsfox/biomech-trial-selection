...
@author:
    ...
    of selecting gait cycles and comparing the outputs. The outputs from this
    script are subsequently used in the research question analysis scripts.
...
#This is time consuming, so would avoid repeating
...
# %% Older piloting...eventually delete...
