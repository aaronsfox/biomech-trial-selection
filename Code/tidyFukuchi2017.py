...
@author:
    ...
    This function tidied up the Fukuchi et al. (2017) C3D data files into individual
    participant folders for later access. After running once the code will no 
    longer work, and simply served as a way to initially manage the dataset.
